...
export const portfolioData = {
  ...
  projects: [
    ...
    {
      id: 12,
      title: "CSUF Jupyter-Powered Learning: Data Literacy & AI Fluency",
      description:
        "Designed and deployed a Jupyter-powered digital learning environment at Cal State Fullerton, empowering over 500 undergraduate students and 80 faculty with hands-on access to Python, AI, and data science tools. The platform cultivates data literacy, AI fluency, and computational proficiency by integrating real-world datasets and practical assignments into STEM and interdisciplinary courses. Project outcomes include measurable gains in student engagement, AI and data skills, and increased adoption across multiple departments through course modules and faculty professional development.",
      images: ["/project/nautilus/2025-JupyterCon-Poster-v5.png"],
      technologies: [
        "JupyterHub",
        "Python",
        "Pandas",
        ...
        "Canvas LTI",
        "Anaconda",
        "Cal State Fullerton HPC",
      ],
      category: "EdTech & Data Science",
      year: "2025",
      status: "Live",
      liveUrl: "/project/nautilus/CSUF PDF Remediation - ASU CIC.pdf",
      highlights: [
        "Developed and administered a scalable JupyterHub platform for CSUF faculty and students with seamless Canvas integration (LTI)",
        "Enabled hands-on Python, AI, and data science activities in large-enrollment STEM courses and undergraduate research programs",
        "Facilitated adoption through two key programs: 100i Undergraduate Research and Mosaic Professional Development for faculty",
        "Demonstrated measurable improvement in student self-assessed proficiency in data literacy, AI, and computational skills",
        "Curated open educational resources, real-world datasets, and reproducible Jupyter notebooks for broad curricular use",
        "Presented results and best practices at academic conferences; highlighted as a leading model for institutional AI education adoption",
        "Secured enthusiastic faculty engagement and institutional support for continued expansion and innovation",
      ],
      featured: false,
    },
    {
      id: 13,
      title: "ATI PDF Accessibility Remediation Tool",
      description:
        "Developed a fully automated PDF accessibility remediation platform for Cal State Fullerton, empowering students, faculty, and staff with accessible digital content in compliance with ADA and Section 508. This tool leverages AWS Bedrock, Lambda, Cognito, and a modern React frontend to deliver scalable, AI-powered remediation of PDF documents for people with disabilities. Users securely login and can submit PDF files, which are processed to meet regulatory accessibility standards (such as readable text, proper tagging, and alternative text), ensuring equitable access to essential information and resources campus-wide.",
      images: ["/project/ati/01-ati.png", "/project/ati/02-ati.png"],
      technologies: [
        "React",
        "AWS Bedrock",
        "AWS Lambda",
      ...
      year: "2026",
      status: "Live",
      liveUrl: "https://prod.d3bideomjfygx.amplifyapp.com/",
      highlights: [
        "Automated PDF accessibility remediation for large-scale institutional use, enabling compliance with ADA and Section 508",
        "Utilizes AWS Bedrock and Lambda for scalable, serverless AI-driven PDF remediation workflows",
        "Implements secure authentication and user management with AWS Cognito",
        "React and TypeScript frontend for a seamless, user-friendly submission and remediation tracking experience",
        "Delivers accessible, tagged PDFs with alt text, structure elements, and screen reader compatibility",
        "Supports thousands of students, faculty, and staff in accessing essential university content",
        "Results in significant reduction in manual remediation efforts for ATI teams and enhanced digital equity for all users",
      ],
      featured: true,
    },
  ],
